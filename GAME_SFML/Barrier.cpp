...
#include <math.h>
Barrier::Barrier(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, sf::Vector2f size, sf::Vector2f position) :
...
void Barrier::Update(float deltaTime, Player player)
{
...
void Barrier::OnCollision(sf::Vector2f direction)
{
...
void Barrier::OnCollision2(sf::Vector2f direction)
{
	bool coll_X = false, coll_Y = false;
	if (direction.x < 0.0f)
	{
